...
export const seoLandingPages: SeoLandingPage[] = [
  {
    ...
    metaDescription: "B2B leadgeneratie die start bij koopsignalen, niet bij koude lijsten. Wij ontwerpen en bouwen een systeem van data, proces en outreach dat voorspelbaar gesprekken oplevert.",
    ...
    solutionLead: "Wij combineren koopsignalen, scherpe segmentatie en multichannel opvolging tot één werkend proces. Jij houdt de regie en voert de gesprekken; wij ontwerpen, bouwen, draaien en optimaliseren. Het model bestaat uit vier stappen.",
    features: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Wat als we hier zelf geen tijd voor hebben?", a: "Dan is uitbesteden het overwegen waard. Wij ontwerpen, bouwen en draaien het volledige systeem — data, copy, campagnes en opvolging — terwijl jij alleen de gesprekken voert. Er komt geen extra werk bij je team te liggen." },
    ],
    relatedSolutions: [
      { slug: "outbound-automatisering", label: "Outbound automatisering" },
  ...
  },
  {
    ...
    metaDescription: "Zakelijke leads uit een gekochte lijst leveren zelden gesprekken op. Wij ontwerpen en bouwen een eigen leadmotor op basis van je ICP en actuele koopsignalen.",
    ...
    solutionLead: "Wij ontwerpen en bouwen een systeem dat zakelijke leads doorlopend aanvult op basis van je ICP en actuele signalen. Als officiële Apollo-partner werken we met actuele prospect-data en verrijking — maar de machine is het verhaal, niet de tool.",
    features: [
  ...
  },
  {
    ...
    solutionLead: "Wij ontwerpen en bouwen een acquisitieproces dat start bij een actueel koopmoment. Je prospect merkt het verschil in de eerste zin: er is een reden voor het contact. Sales krijgt warmere gesprekken, jij krijgt een voorspelbare pipeline.",
    features: [
  ...
  },
  {
    ...
    solutionLead: "Wij verkopen geen leads. Wij ontwerpen en bouwen een groeimachine: proces, data en outreach in één systeem dat blijft draaien, ook als jij er niet naar kijkt. Voordat we iets bouwen, leggen we samen vast wat succes is — de CTQ, oftewel Critical to Quality. Daarna ontwerpen en bouwen we in vier stappen, één bottleneck per keer.",
    features: [
    ...
    faqs: [
      ...
      { q: "Wat moet ik zelf doen?", a: "Gesprekken voeren. Wij ontwerpen, bouwen en draaien het systeem: data, copy, campagnes, opvolging en rapportage. Jij sluit aan bij de wekelijkse update en zit aan tafel bij de afspraken die eruit komen. Er komt geen extra werk bij je team te liggen." },
  ...
  },
  {
    ...
    metaDescription: "Cold e-mail uitbesteden? Meer volume is niet het antwoord. Wij ontwerpen en bouwen multichannel outreach op koopsignalen: e-mail, LinkedIn en telefoon in één systeem. Inclusief deliverability.",
    h1: "Cold e-mail uitbesteden: relevantie boven volume",
    intro: "Duizend mails versturen is makkelijk. Reacties krijgen niet. De meeste cold e-mail mislukt niet door de tooling, maar door het ontbreken van een reden om te mailen. Wij ontwerpen en bouwen outreach die start bij een koopsignaal: een vacature, een investering, een groeispurt. Eén bericht met een scherpe hypothese over het probleem doet meer dan honderd zonder. Volledig managed, inclusief deliverability en domeinbeheer.",
