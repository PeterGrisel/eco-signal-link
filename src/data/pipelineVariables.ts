...
export const pipelinePhases = [
  { key: "attract", label: "Attract", subtitle: "Wie u bereikt", icon: "Magnet", color: "from-orange-500/20 to-orange-600/10" },
  { key: "reach", label: "Reach", subtitle: "Het juiste moment", icon: "Crosshair", color: "from-blue-500/20 to-blue-600/10" },
  { key: "resonate", label: "Resonate", subtitle: "Wat u zegt", icon: "MessageSquare", color: "from-purple-500/20 to-purple-600/10" },
  { key: "execute", label: "Execution", subtitle: "Hoe u het doet", icon: "RefreshCw", color: "from-green-500/20 to-green-600/10" },
  { key: "convert", label: "Convert", subtitle: "Van reactie naar klant", icon: "TrendingUp", color: "from-primary/20 to-primary/10" },
];
