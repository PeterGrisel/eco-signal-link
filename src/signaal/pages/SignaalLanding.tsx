        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <h2 className="font-display font-bold text-3xl md:text-5xl tracking-tight mb-4">
              Alles voor{" "}
              <span className="text-gradient">eenmalig €97</span>
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
              Geen abonnement. Eén betaling, levenslang toegang. Dit is wat u ontvangt:
            </p>
          </motion.div>

          <div className="max-w-4xl mx-auto space-y-3">
            {[
              { icon: Layers, title: "7-laags interactieve journey", desc: "Elke laag bestaat uit Waarom, Wat en Hoe — zodat u niet alleen configureert, maar ook begrijpt.", value: "Kernprogramma" },
              { icon: Bot, title: "AI Strategy Agent", desc: "Een persoonlijke strategiecoach die real-time meekijkt, vragen beantwoordt en advies geeft op basis van uw input.", value: "Inclusief" },
              { icon: FileText, title: "Persoonlijke Blueprint + PDF Export", desc: "Uw volledige signaalconfiguratie als professioneel document. Download en deel met uw team.", value: "Inclusief" },
              { icon: Wrench, title: "Installatie Setup Checklist", desc: "Stap-voor-stap gids per tool om uw gekozen stack in te richten. Apollo, Clay, HubSpot — alles gedekt.", value: "Inclusief" },
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-1">
                    <h3 className="font-display font-semibold text-base text-foreground">{item.title}</h3>
                    <span className="hidden sm:inline-block px-2 py-0.5 rounded-full bg-primary/10 text-primary text-[10px] font-mono tracking-wider shrink-0">
                      {item.value}
                    </span>
                  </div>
          ...
          >
            <p className="text-muted-foreground text-sm mb-6">
              Totale waarde: <span className="line-through">€500+</span>{" "}
              <span className="text-primary font-display font-bold text-lg">€97</span>{" "}
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[95] w-[90vw] max-w-md"
          >
      ...
      <motion.button
        ...
        className={`fixed bottom-6 right-6 z-[95] flex items-center gap-2 px-5 py-3 rounded-full shadow-lg transition-all font-display font-semibold text-sm ${
          open
