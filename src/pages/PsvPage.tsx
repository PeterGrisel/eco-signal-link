...
const tracks = [
  {
    ...
    desc: "Wij brengen Brainport en de rest van Nederland in kaart, filteren op wie bij PSV past en activeren beslissers per golf. Uw team krijgt gesprekken, geen lijsten.",
  },
  {
    tag: "ABM",
...
const excelsiorVsPsv = [
  { label: "Markt", excelsior: "Regio Rotterdam", psv: "Brainport + landelijk" },
...
const modelSteps = [
  ...
  { title: "Hypothese", desc: "Samen met commercie: wie past bij PSV en waarom nu?" },
...
const levels = [
  { name: "Qualified", rule: "Past bij PSV", action: "Nurture, blijft warm" },
...
const signals = [
  "Nieuwe vestiging of uitbreiding in Brainport",
...
const faqs = [
  ...
  {
    q: "Hoe starten we?",
    a: "Met een pilot van 90 dagen op één spoor, bijvoorbeeld PSV Vrouwen of nieuwe partners in Brainport. Daarna schalen we op wat werkt.",
  },
];
...
const PsvPage = () => {
  usePageMeta({
    ...
    description:
      "Hoe B2B Groeimachine het commerciële team van PSV helpt nieuwe partners te werven, bestaande partners te laten groeien en PSV Vrouwen commercieel op de kaart te zetten. Met de Excelsior-case.",
    canonical: "https://www.b2bgroeimachine.io/voor/psv",
    themeColor: RED,
  });
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="mt-8 md:mt-10 grid md:grid-cols-[1fr_auto] gap-8 items-end">
              <p className="text-base md:text-xl max-w-2xl leading-relaxed text-foreground/85">
                Wij bouwen voor PSV een commerciële engine die de hele zakelijke markt in kaart brengt, beslissers activeert
      ...
      {/* 02 — ZO HELPEN WIJ PSV */}
      <section className="py-16 md:py-24" style={STRIPES}>
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeader index="02" title="Zo helpen wij PSV" />
            ...
            <div>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-[5.5rem_1fr_1fr] gap-x-4 text-sm">
                  ...
                  <span className="uppercase text-[10px] tracking-[0.2em] pb-2" style={{ fontFamily: MONO, color: RED }}>PSV</span>
              ...
              <p className="mt-6 text-[11px] text-white/40 leading-relaxed" style={{ fontFamily: MONO }}>
                Cijfers zijn casewaarden van Excelsior en gelden als benchmark, niet als garantie voor PSV.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-10 lg:gap-20 items-end">
            <div>
              <p className="text-2xl md:text-4xl leading-snug max-w-2xl mb-10" style={{ fontFamily: SERIF }}>
                In één gesprek laten wij zien hoe de Excelsior-engine eruitziet op de schaal van PSV, en met welk spoor we
                starten.
              </p>
              ...
              <a
                href="mailto:peter.grisel@rebelforce.nl?subject=PSV%20x%20B2B%20Groeimachine"
      ...
      <div className="py-4 border-b" style={{ backgroundColor: INK, borderColor: "rgba(255,255,255,0.1)" }}>
        ...
        >
          ...
          <span className="uppercase" style={{ color: RED }}>Van Excelsior naar Eindhoven</span>
          <span className="text-white/60">#GroeimetAI #Brainport</span>
        </div>
      </div>
