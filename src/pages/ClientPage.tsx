...
function hslColor(hsl: string, deltaL = 0, satMul = 1): string {
...
const ClientPage = () => {
  ...
  const t = isEn
    ? {
        ...
        downloadHere: `Download the ${row.company_name} playbook (PDF)`,
        prev: "Previous page",
        next: "Next page",
        zoomOut: "Zoom out",
        zoomIn: "Zoom in",
    ...
    : {
        ...
        downloadHere: `Download het ${row.company_name} playbook (PDF)`,
        prev: "Vorige pagina",
      ...
      <section className="relative min-h-screen flex items-center border-b border-border bg-background overflow-hidden">
        ...
        >
          {[
            ...
            { d: "M0 514C147.5 514 195.5 514 274 514C352.5 514 395 514 478 514C561 514 593 528 671 528C749 528 802 510 880 510C958 510 1011 528 1089 528C1167 528 1212 514 1290 514C1368 514 1364.5 514 1440 514", color: hslColor(primaryHsl, 22, 0.85), delay: 0.3 },
            ...
            { d: "M0 364C145.5 364 191 360.5 269 401C347 441.5 408.5 464.5 506.5 484.5C604.5 504.5 658 487 716 480C774 473 803.5 483.5 859 504.5C914.5 525.5 943 536.5 1024.5 536.5C1106 536.5 1168 492 1232.5 484C1297 476 1361 480 1440 480", color: hslColor(glowHsl, 18, 0.9), delay: 0.6 },
          ].map((p, i) => (
