...
import pdfAsset from "@/assets/shots-playbook.pdf.asset.json";
...
// Shots brand palette: eco green, lime accent, dark surface
const HEGO = {
  primary: "#E30613", // Shots green
  primaryGlow: "#FF5A5A", // lime accent
  silver: "#F5B8B8",
  surface: "#1A0606",
};
...
const ShotsPage = () => {
  ...
  usePageMeta({
    ...
    description:
      "Persoonlijk playbook voor Shots: hoe wij installateurs, architecten, prefabricators en distributeurs activeren rond roofing, facade, lining en geo.",
  ...
  // Client-specific tracking (client_slug: "shots")
  useEffect(() => {
    const clientSlug = "shots";
    trackEvent("client_page_view", "client_page", clientSlug, {
      client_slug: clientSlug,
      path: "/voor/shots",
    });
    startTimeOnPage("/voor/shots");
    trackScrollDepth();
    return () => {
      flushTimeOnPage();
      stopScrollDepth();
  ...
  useEffect(() => {
    if (page > 1) {
      trackEvent("client_pdf_page_view", "client_page", "shots", {
        client_slug: "shots",
        pdf_page: page,
      });
    }
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="flex flex-col items-center text-center max-w-4xl 2xl:max-w-6xl 3xl:max-w-7xl mx-auto">
            ...
            >
              <p className="text-base md:text-lg text-foreground/90 leading-relaxed px-6 py-5">
                Persoonlijk Market Activation Playbook voor Shots. Hoe wij installateurs, architecten, prefabricators en distributeurs activeren rond roofing, facade, lining en geo.
              </p>
            </FrostedGlassCard>
            <a
              href="#playbook"
        ...
        <div className="container mx-auto px-4 md:px-6 w-full">
          <div className="max-w-3xl 2xl:max-w-5xl 3xl:max-w-6xl mx-auto text-center mb-10">
            ...
            <h2 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl 3xl:text-9xl tracking-tight leading-[1.05] mb-4">
              ...
              <br />
              <span style={{ color: HEGO.primaryGlow }}>voor Shots.</span>
            </h2>
            <FrostedGlassCard
            ...
            >
              <p className="text-base md:text-lg text-foreground/90 leading-relaxed px-6 py-5">
                Het volledige playbook. Onze analyse, aanpak en eerste plan voor Shots. Doorbladeren kan hieronder of download de PDF.
              </p>
            </FrostedGlassCard>
          </div>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-border shadow-2xl bg-background">
              <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-card/60">
                <div className="flex items-center gap-2 text-sm font-medium">
                  ...
                  Shots_Market_Activation_Playbook.pdf
                </div>
                <a
                  href={pdfAsset.url}
                  download
                  onClick={() => trackCTA("shots_playbook_download", pdfAsset.url)}
        ...
        <div className="container mx-auto px-4 md:px-6 w-full">
          <div className="max-w-3xl 2xl:max-w-5xl 3xl:max-w-6xl mx-auto text-center mb-12">
            ...
            <h2 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl 3xl:text-9xl tracking-tight leading-[1.05] mb-6">
              Acht playbooks.
              <br />
              <span style={{ color: HEGO.primaryGlow }}>Eén werkend groeisysteem voor Shots.</span>
            </h2>
            <FrostedGlassCard
              className="max-w-2xl 2xl:max-w-4xl 3xl:max-w-5xl mx-auto"
              background={`linear-gradient(135deg, hsl(var(--foreground) / 0.10), hsl(var(--foreground) / 0.02))`}
      ...
      {/* Pricing — in Shots brandkleur via CSS variable override */}
      <div
        className="shots-brand"
        style={{
          ["--primary" as any]: "356 95% 46%",
      ...
      <div className="min-h-screen flex items-center">
        <div className="w-full">
          <WaitlistHero logoSrc={shotsLogo.url} logoAlt="Shots logo" accentColor={HEGO.primary} />
        </div>
      </div>
