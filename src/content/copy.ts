...
export const COPY = {
  ...
  schaal: {
    ...
    steps: [
      { label: "Markt", value: "2.000", unit: "bedrijven", note: "Adresseerbaar binnen uw ICP." },
      { label: "Beslissers", value: "4.000", unit: "contacten", note: "Gemiddeld 2 beslissers per account." },
      { label: "Engaged", value: "200", unit: "in beweging", note: "Reacties, replies, profielbezoeken." },
