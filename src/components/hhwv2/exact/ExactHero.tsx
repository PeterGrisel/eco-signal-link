      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 relative w-full h-[600px] flex items-center justify-center select-none"
          >
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-visible" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Central Box coordinates: x: 50%, y: 40% (x: 280-420, y: 210-290 in 700x500 box approx) */}
              {/* Coordinates are mapped based on responsive SVG viewBox or dynamic calculations. We'll use percentage-based styling or a container-relative path drawing */}
              
              {/* 1. Funding signals (Left-top) -> Engine */}
              <path d="M 120 70 Q 200 120, 310 215" fill="none" stroke="url(#glowGrad)" strokeWidth="1.5" strokeDasharray="4 4" className="animate-[dash_10s_linear_infinite]" />
              
              {/* 2. Hiring signals (Center-left-top) -> Engine */}
              <path d="M 210 70 Q 240 130, 325 215" fill="none" stroke="url(#glowGrad)" strokeWidth="1.5" strokeDasharray="4 4" className="animate-[dash_8s_linear_infinite]" />
              
              {/* 3. Website bezoeken (Center-top) -> Engine */}
              <path d="M 305 70 Q 320 140, 340 215" fill="none" stroke="url(#glowGrad)" strokeWidth="1.5" strokeDasharray="4 4" className="animate-[dash_12s_linear_infinite]" />
              
              {/* 4. Concurrent research (Center-right-top) -> Engine */}
              <path d="M 400 70 Q 380 140, 360 215" fill="none" stroke="url(#glowGrad)" strokeWidth="1.5" strokeDasharray="4 4" className="animate-[dash_7s_linear_infinite]" />
              
              {/* 5. Ad engagement (Right-top) -> Engine */}
              <path d="M 495 70 Q 460 130, 375 215" fill="none" stroke="url(#glowGrad)" strokeWidth="1.5" strokeDasharray="4 4" className="animate-[dash_9s_linear_infinite]" />
              
              {/* 6. Tool stack (Far-right-top) -> Engine */}
              <path d="M 580 70 Q 500 120, 390 215" fill="none" stroke="url(#glowGrad)" strokeWidth="1.5" strokeDasharray="4 4" className="animate-[dash_11s_linear_infinite]" />

              {/* Connections from Engine:
                  - To Operators & Logic on the right (x: 520, y: 220)
                  - To High-fit Account below (x: 350, y: 350)
              */}
              {/* Engine -> Operators */}
              <path d="M 405 250 H 510" fill="none" stroke="url(#glowGrad)" strokeWidth="2" strokeDasharray="4 4" />
              
              {/* Engine -> High-fit Account */}
              <path d="M 350 280 V 350" fill="none" stroke="url(#glowGrad)" strokeWidth="2.5" />
              <circle cx="350" cy="350" r="4" fill="var(--primary)" />
            </svg>
            ...
            >
              ...
              <div className="mb-4">
                ...
                >
                  <div className="flex items-center gap-2">
                    <PhoneCall className="h-3.5 w-3.5 text-primary animate-bounce" />
              ...
              <div className="flex items-center justify-between pt-2 border-t border-primary/10">
                ...
                <div className="flex items-center gap-1.5">
                  {/* Small custom icons for tool stack (Salesforce, HubSpot, Slack) */}
