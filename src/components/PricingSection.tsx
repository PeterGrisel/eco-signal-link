...
const T = {
  nl: {
    ...
    monthlyMeta: "90 dagen pilot · daarna maandelijks opzegbaar",
    ...
    ctaScan: "Boek een gratis call →",
    ctaTalk: "Boek een gratis call →",
    ctaFooter: "Boek een gratis call →",
  ...
  en: {
    ...
    monthlyMeta: "90-day pilot · cancel monthly after",
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          "Aanvullende accountselectie en verrijking",
          "Klantcase, proof point of relevante use-case",
          "Korte inputronde met accountmanager, klant of interne expert",
          "Aangescherpte message angle en e-mailvarianten",
          "Hyperpersonalisatie voor een beperkte prioriteitenlijst",
          "Extra activatie binnen bestaande e-mail-, LinkedIn- en signaleringslaag",
        ],
        footer: "Voorwaarde: alleen beschikbaar naast een actieve Growth Engine of Scale Engine.",
      },
      {
        icon: Database,
        title: "CRM Boost",
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        "Additional account selection and enrichment",
        "Customer case, proof point or relevant use case",
        "Short input round with account manager, customer or internal expert",
        "Sharpened message angle and email variants",
        "Hyper-personalisation for a limited priority list",
        "Extra activation within existing email, LinkedIn and signal layer",
      ],
      footer: "Condition: only available alongside an active Growth Engine or Scale Engine.",
    },
    {
      icon: Database,
      title: "CRM Boost",
