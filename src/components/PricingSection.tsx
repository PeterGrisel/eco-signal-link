...
const buildBoosts = (lang: Lang, fmt: (eur: number) => string) => {
  ...
  if (lang === "nl") {
    return [
      ...
      },
      {
        ...
        desc: "Activeer een extra doelgroep, productgroep, regio of campagnehoek binnen uw bestaande groeimachine.",
        items: [
          "Extra ICP / doelgroep",
          "Extra accountlijst en verrijking",
          "Eigen campagneflow",
          "Aangepaste messaging en e-mailvarianten",
          "Klantcases en relevante proof points",
          "Korte interviews met accountmanagers, klanten of interne experts",
          "Hyperpersoonlijke outreach voor prioriteitsaccounts",
          "Extra LinkedIn-activatie",
          "Signalen en engagement in bestaande opvolging",
          "Maandelijkse optimalisatie",
        ],
        footer: "Geen aparte setupkosten. Alleen beschikbaar naast een actieve B2B Groeimachine / Engine-omgeving.",
      },
      {
        icon: Database,
        title: "CRM Boost",
  ...
  return [
    ...
    },
    {
      ...
      desc: "Activate an extra audience, product line, region or campaign angle within your existing growth machine.",
      items: [
        "Extra ICP / audience",
        "Extra account list and enrichment",
        "Dedicated campaign flow",
        "Custom messaging and email variants",
        "Customer cases and relevant proof points",
        "Short interviews with account managers, customers or internal experts",
        "Hyper-personalised outreach for priority accounts",
        "Extra LinkedIn activation",
        "Signals and engagement in existing follow-up",
        "Monthly optimisation",
      ],
      footer: "No separate setup costs. Only available alongside an active B2B Growth Machine / Engine environment.",
    },
    {
      icon: Database,
      title: "CRM Boost",
