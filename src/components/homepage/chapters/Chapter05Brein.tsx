...
export default function Chapter05Brein() {
  return (
    <ChapterFrame
      ...
      title={<>Het <span className="text-primary">Commerciële Brein</span></>}
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <ul className="space-y-3">
            {benefits.map((b) => (
              <li key={b} className="flex items-start gap-3 rounded-xl border border-foreground/10 bg-card/95 shadow-lg px-4 py-3">
