...
export default function Chapter01Scenario() {
  return (
    ...
    >
      ...
      {/* Context — van kennis in hoofden naar digitaal meetbare context */}
      <div className="mt-20 md:mt-28">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-14">
          ...
          <h3 className="font-display text-2xl md:text-3xl lg:text-[2.25rem] font-medium leading-[1.1] mb-4 text-foreground [text-shadow:0_1px_8px_rgba(0,0,0,0.4)]">
            Van kennis in hoofden naar <span className="text-primary">digitaal meetbare context.</span>
          </h3>
          <p className="text-sm md:text-base text-foreground/80 leading-relaxed [text-shadow:0_1px_8px_rgba(0,0,0,0.4)]">
            Waarom doen we wat we doen? Hoe starten we sales? Als die context niet wordt vastgelegd, blijven signalen onzichtbaar.
          </p>
        </div>
