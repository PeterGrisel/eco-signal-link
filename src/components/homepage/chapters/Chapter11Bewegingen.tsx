      ...
      <div className="relative">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {motions.map((m) => (
            <div
              key={m.n}
              className="group rounded-2xl border border-foreground/10 bg-background/40 backdrop-blur-sm p-6 hover:border-primary/40 hover:bg-background/60 transition-colors"
            >
