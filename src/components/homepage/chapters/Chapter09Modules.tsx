      ...
      {items.map((m) => (
        <div
          ...
          className={`flex items-center gap-3 rounded-lg border px-3 py-2.5 ${
            accent ? "border-primary/25 bg-primary/[0.12]" : "border-foreground/10 bg-background/45 backdrop-blur-md"
          }`}
        >
  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-foreground/10 bg-background/40 backdrop-blur-md p-6">
