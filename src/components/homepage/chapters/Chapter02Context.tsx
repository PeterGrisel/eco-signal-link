  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-3 gap-4 lg:gap-0">
        ...
        <div className="rounded-l-2xl rounded-r-2xl lg:rounded-r-none border border-foreground/10 bg-card/80 backdrop-blur-md shadow-lg p-6">
        ...
        <div className="rounded-2xl lg:rounded-none border border-primary/30 bg-card/85 backdrop-blur-md shadow-xl ring-1 ring-primary/30 p-6 lg:-mx-px lg:-my-4 lg:py-10 relative z-10">
          <div className="flex items-center gap-2 mb-5">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="grid grid-cols-2 gap-2 w-full">
              {contextPieces.map((p, i) => (
                <div key={i} className="flex items-center gap-1.5 rounded-md bg-card/85 backdrop-blur-md shadow-lg border border-foreground/10 px-2 py-1.5">
        ...
        <div className="rounded-2xl lg:rounded-l-none border border-foreground/10 bg-card/80 backdrop-blur-md shadow-lg p-6">
          <div className="flex items-center gap-2 mb-5">
          ...
          <div className="rounded-md bg-card/85 backdrop-blur-md shadow-lg border border-foreground/10 px-3 py-2 mb-4 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-2 mb-5">
            {outputs.map((o, i) => (
              <div key={i} className="flex flex-col items-center gap-1 rounded-md bg-card/85 backdrop-blur-md shadow-lg border border-foreground/10 py-3">
