    ...
    >
      <div className="container max-w-6xl mx-auto px-4 md:px-6">
        ...
        <motion.div
          ...
          className="group relative mx-auto max-w-3xl rounded-2xl bg-background/75 border border-foreground/10 px-6 py-8 md:px-10 md:py-10 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] text-center mb-14 md:mb-20 overflow-hidden"
        >
