...
const streams = [
  {
    ...
    signals: ["Nieuwe vacatures", "Bedrijfsregistraties", "Website-bezoek", "LinkedIn-interactie"],
  },
  {
    icon: Users,
    title: "Recruitment",
    description: "Adviseurs, specialisten en talent dat bij u past. Van actieve kandidaten tot professionals die over 1-2 jaar de perfecte fit zijn.",
