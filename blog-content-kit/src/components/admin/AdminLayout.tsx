...
import { FileText, Globe, LogOut, Settings, BarChart3, Circle, Activity, LayoutDashboard, Menu, X, Radio, Boxes, BookOpen, BookA, ClipboardList, Inbox, Network, Gift } from "lucide-react";
