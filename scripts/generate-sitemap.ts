...
const BASE_URL = "https://www.b2bgroeimachine.io";
...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/de-engine", changefreq: "monthly", priority: "0.9" },
  { path: "/werkomgeving", changefreq: "monthly", priority: "0.9" },
  ...
  { path: "/koude-acquisitie", changefreq: "monthly", priority: "0.8" },
  { path: "/acquisitie-uitbesteden", changefreq: "monthly", priority: "0.8" },
  { path: "/leadgeneratie-uitbesteden", changefreq: "monthly", priority: "0.8" },
  { path: "/cold-email-uitbesteden", changefreq: "monthly", priority: "0.8" },
  { path: "/apollo-io-partner-nederland", changefreq: "monthly", priority: "0.7" },
  { path: "/sales-automation-mkb", changefreq: "monthly", priority: "0.7" },
  { path: "/leadgeneratie-maakindustrie", changefreq: "monthly", priority: "0.7" },
  { path: "/leadgeneratie-tech-services", changefreq: "monthly", priority: "0.7" },
  { path: "/leadgeneratie-zakelijke-dienstverlening", changefreq: "monthly", priority: "0.7" },
  { path: "/give-aways", changefreq: "weekly", priority: "0.6" },
  { path: "/demo", changefreq: "monthly", priority: "0.5" },
  { path: "/hcm-arnhem", changefreq: "monthly", priority: "0.6" },
