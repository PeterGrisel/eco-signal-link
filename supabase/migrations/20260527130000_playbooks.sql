-- Playbooks: AI-gegenereerde GTM-gidsen op basis van de Groeistack + scenario's

-- Scenario's die de generator dagelijks afwerkt (minst recent eerst)
...
-- Seed scenario's (sector x dienstlijn)
